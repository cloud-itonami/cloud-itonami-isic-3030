...
- human sign-off for :high/:safety-critical robot actions (e.g. handling flight-critical structures, composites and large assemblies)
...
## Operating states
requirements : simulate : verify : approve : manufacture : audit
