# Operator Quickstart — Aircraft and Aerospace Manufacturing Enablement

Shortest path from clone to a verified local dry-run for **ISIC 3030** (`cloud-itonami-isic-3030`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3030.git
cd cloud-itonami-isic-3030
```
...
- Blueprint governor key: `aerospace-manufacturing-governor`
- Likely source path: `aerospace.governor.cljc`
